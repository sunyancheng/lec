...
exports.ObjectArrayMerge = exports.traverse = exports.rulesGenerator = exports.validationGenerator = exports.recurseTreeData = exports.recurseTreeDataID = exports.getPureObject = exports.REQUEST_MANUAL = exports.REQUEST = void 0;
var request_1 = require("./request");
Object.defineProperty(exports, "REQUEST", { enumerable: true, get: function () { return request_1.REQUEST; } });
Object.defineProperty(exports, "REQUEST_MANUAL", { enumerable: true, get: function () { return request_1.REQUEST_MANUAL; } });
// Object 去除空值
var getPureObject = function (criteria, filter) {
...
var recurseTreeDataID = function (data) {
...
exports.recurseTreeDataID = recurseTreeDataID;
// 遍历修改 TreeData
var recurseTreeData = function (_a) {
...
exports.recurseTreeData = recurseTreeData;
// 根据 advRules, 生成 rules
var validationGenerator = function (field, rules) {
...
// rules 和 advRules 合并
var rulesGenerator = function (field, rules, advRules) {
    if (rules === void 0) { rules = []; }
    if (advRules === void 0) { advRules = {}; }
    return Object.keys(advRules).length ? __spreadArray(__spreadArray([], __read(rules)), __read(exports.validationGenerator(field, advRules))) : rules;
};
exports.rulesGenerator = rulesGenerator;
var traverse = function (array, item, matchKey) {
    var find = false;
...
var ObjectArrayMerge = function (current, incoming, matchKey) {
    ...
    incoming.forEach(function (item) {
        ...
        if (index === -1) {
            exports.traverse(a, item, matchKey);
        }
    });
    return a;
};
exports.ObjectArrayMerge = ObjectArrayMerge;
// export const UTILS = {
//   REQUEST,
//   REQUEST_MANUAL,
//   ObjectArrayMerge,
