...
exports.REQUEST_MANUAL = exports.REQUEST = void 0;
...
var REQUEST = function (API, namespace, action, payload, onSuccess, onError) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                if (r instanceof Error && r.stack && r.message) {
                    if (onError)
                        onError(r);
                    return [2 /*return*/, leap_ui_1.message.error(r.message)];
                }
                ...
                if (status !== HTTP_SUCCESS_CODE ||
                    ...
                    return [2 /*return*/, leap_ui_1.message.error(msg)];
                }
                if (!silentMessage) {
                    leap_ui_1.message.success((TEXT[firstUpperCase(action)] || "操作") + "\u6210\u529F");
                }
                if (onSuccess) {
...
var REQUEST_MANUAL = function (API, namespace, action, onSuccess) {
    return function (payload) {
        return exports.REQUEST(API, namespace, action, payload, onSuccess);
    };
};
exports.REQUEST_MANUAL = REQUEST_MANUAL;
