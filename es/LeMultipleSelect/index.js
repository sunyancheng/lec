...
export var LeMultipleSelect = function (_a) {
    ...
    return (React.createElement(Select, __assign({ placeholder: placeholder, mode: "multiple", maxTagCount: maxTagCount }, props), values.map(function (_a) {
