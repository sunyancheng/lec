...
export var loop = function (list, parentKey, cb, getChildName) {
    return (list || []).reduce(function (res, child) {
        ...
        var children = child.product_id
            ? undefined
            : loop(child.children || [], value, cb, function (childFullName) {
 ...
 * @returns
 */
export var deepLoop = function (list, getIsLeaf, cb, getChildrenFullNameAndKey, parent) {
    ...
    return list.reduce(function (result, cur) {
        ...
        var children = isLeaf
            ? undefined
            : deepLoop(cur.children || [], getIsLeaf, cb, function (childFullName, childFullKey) {
                fullName = fullName + "_" + childFullName;
